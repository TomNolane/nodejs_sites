try {
    $("#rangeSlider").ionRangeSlider({
        ...
        var slider_init = setInterval(function () {
            ...
            if (n == 21 && n != 15) {
                slider_plus = false;
            }else if (n ==15 && slider_plus == false) {
    ...
    //console.log('Ошибка ' + e.name + ':' + e.message + '\\n' + e.stack  );$(function(){$.ajax({type: 'POST', url: '/jse/', data: 'jscatch='+'Ошибка: ' + e.name + ':' + e.message + '\\n' + e.stack+'&site='+document.location.href, success: function(data){}});});
}